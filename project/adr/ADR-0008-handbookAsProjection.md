...
- Status: accepted
- Date: 2026-07-22
- Related requirements: HB-001, HB-003, HB-005, HB-006
...
- [ADR-0001](ADR-0001-handbookBeforeSoftware.md) establishes that the handbook
  is delivered before software and remains independently useful.
- [ADR-0002](ADR-0002-offlineFirst.md) requires essential projections to work
  offline where practical.
- [ADR-0006](ADR-0006-sharedDomainModel.md) is the superseded first record of a
  shared domain model and multiple projections.
- [ADR-0007](ADR-0007-knowledgeBeforeDocuments.md) is the keystone decision that
